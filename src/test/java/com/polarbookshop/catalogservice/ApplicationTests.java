...
class ApplicationTests {
    ...
    void whenGetRequestWithIdThenBookReturned() {
        ...
        var createBookRequest = new BookRequest(bookIsbn, "Title", "Author", 9.90, "Polarsophia");
    ...
    void whenPostRequestThenBookCreated() {
        var createBookRequest = new BookRequest("1231231231", "Title", "Author", 9.90, "Polarsophia");
        ...
        webTestClient
                ...
                .expectBody(Book.class).value(actualBook -> {
                    assertThat(actualBook).isNotNull();
                    assertThat(actualBook.isbn()).isEqualTo(createBookRequest.isbn());
                });
    }
